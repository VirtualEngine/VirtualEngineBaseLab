configuration vBaseLab {
    ...
    $activeDirectory = @{
        OUs = @(
            @{ Name = 'Lab'; Description = 'Training group and user resources'; }
                @{ Name = 'Computers'; Path = 'OU=Lab'; Description = 'Training computer accounts'; }
                @{ Name = 'Groups'; Path = 'OU=Lab'; Description = 'Training security and distribution groups'; }
                @{ Name = 'Servers'; Path = 'OU=Lab'; Description = 'Training server accounts'; }
                @{ Name = 'Service Accounts'; Path = 'OU=Lab'; Description = 'Training service accounts'; }
                @{ Name = 'Users'; Path = 'OU=Lab'; Description = 'Training department users'; }
                    @{ Name = 'Engineering'; Path = 'OU=Users,OU=Lab'; Description = 'Engineering department user accounts'; }
                    @{ Name = 'Executive'; Path = 'OU=Users,OU=Lab'; Description = 'Company executive user accounts'; }
                    @{ Name = 'Finance'; Path = 'OU=Users,OU=Lab'; Description = 'Finance department user accounts'; }
                    @{ Name = 'Human Resources'; Path = 'OU=Users,OU=Lab'; Description = 'HR departmental user accounts'; }
                    @{ Name = 'Information Technology'; Path = 'OU=Users,OU=Lab'; Description = 'IT departmental user accounts'; }
                    @{ Name = 'Marketing'; Path = 'OU=Users,OU=Lab'; Description = 'Marketing department user accounts'; }
                    @{ Name = 'Sales'; Path = 'OU=Users,OU=Lab'; Description = 'Sales department user accounts'; }
        )

        GPOs = @{
            'Default Lab Policy' = @{ Link = $rootDN; Enabled = $true; }
            'Invoke Workspace Composer' = @{ Link = "OU=Servers,OU=Lab,$rootDN"; Enabled = $false; }
        }
        ...
        Users = @(
            ...
            @{  SamAccountName = 'LOCAL05'; GivenName = 'Tony'; Surname = 'Stark';
                ...
                Path = 'OU=Executive,OU=Users,OU=Lab'; ManagedBy = 'LOCAL05'; }
            ...
            @{  SamAccountName = 'ROAM02'; GivenName = 'Gene'; Surname = 'Poole';
                ...
                Path = 'OU=Engineering,OU=Users,OU=Lab'; ProfileType = 'Roaming'; ManagedBy = 'LOCAL05'; }
            @{  SamAccountName = 'MAND01'; GivenName = 'Ann'; Surname = 'Thrax';
                ...
                Path = 'OU=Engineering,OU=Users,OU=Lab'; ProfileType = 'Mandatory'; ManagedBy = 'ROAM02'; }
            ...
            @{  SamAccountName = 'LOCAL03'; GivenName = 'Robin'; Surname = 'Banks';
                ...
                Path = 'OU=Finance,OU=Users,OU=Lab'; ManagedBy = 'LOCAL05'; }
            @{  SamAccountName = 'ROAM04'; GivenName = 'Owen'; Surname = 'Cash';
                ...
                Path = 'OU=Finance,OU=Users,OU=Lab'; ProfileType = 'Roaming'; ManagedBy = 'LOCAL03'; }
            @{  SamAccountName = 'MAND03'; GivenName = 'Chris'; Surname = 'Cross';
                ...
                Path = 'OU=Finance,OU=Users,OU=Lab'; ProfileType = 'Mandatory'; ManagedBy = 'LOCAL03'; }
            ...
            @{  SamAccountName = 'ROAM01'; GivenName = 'Justin'; Surname = 'Case';
                ...
                Path = 'OU=Information Technology,OU=Users,OU=Lab'; ProfileType = 'Roaming'; ManagedBy = 'LOCAL05'; }
            @{  SamAccountName = 'ROAM05'; GivenName = 'Luke'; Surname = 'Warme';
                ...
                Path = 'OU=Information Technology,OU=Users,OU=Lab'; ProfileType = 'Roaming'; ManagedBy = 'ROAM01'; }
            ...
            @{  SamAccountName = 'LOCAL04'; GivenName = 'Mike'; Surname = 'Raffone';
                ...
                Path = 'OU=Marketing,OU=Users,OU=Lab'; ManagedBy = 'LOCAL05'; }
            @{  SamAccountName = 'ROAM03'; GivenName = 'Claire'; Surname = 'Voyant';
                ...
                Path = 'OU=Marketing,OU=Users,OU=Lab'; ProfileType = 'Roaming'; ManagedBy = 'LOCAL04'; }
            @{  SamAccountName = 'MAND02'; GivenName = 'Mona'; Surname = 'Lott';
                ...
                Path = 'OU=Marketing,OU=Users,OU=Lab'; ProfileType = 'Mandatory'; ManagedBy = 'LOCAL04'; }
            ...
            @{  SamAccountName = 'LOCAL01'; GivenName = 'Warren'; Surname = 'Peace';
                ...
                Path = 'OU=Sales,OU=Users,OU=Lab'; ManagedBy = 'LOCAL05'; }
            @{  SamAccountName = 'LOCAL02'; GivenName = 'Lois'; Surname = 'Bidd';
                ...
                Path = 'OU=Sales,OU=Users,OU=Lab'; ManagedBy = 'LOCAL01'; }
            @{  SamAccountName = 'MAND04'; GivenName = 'Ollie'; Surname = 'Gark';
                Telephone = '01234 567903'; Mobile = '07700 900558'; Fax = '01234 567899';
                Address = 'Columbus Circle'; City = 'New York'; State = 'NYC'; PostCode = '12345'; Country = 'US';
                JobTitle = 'Account Manager'; Department = 'Sales'; Office = 'Stark Tower'; Company = 'Stark Industries';
                Path = 'OU=Sales,OU=Users,OU=Lab'; ProfileType = 'Mandatory'; ManagedBy = 'LOCAL01'; }
            ...
            @{  SamAccountName = 'LOCAL06'; GivenName = 'Ona'; Surname = 'Paar';
                ...
                Path = 'OU=Human Resources,OU=Users,OU=Lab'; ManagedBy = 'LOCAL05'; }
            @{  SamAccountName = 'LOCAL07'; GivenName = 'Ally'; Surname = 'Monie';
                ...
                Path = 'OU=Human Resources,OU=Users,OU=Lab'; ManagedBy = 'LOCAL06'; }
            @{  SamAccountName = 'LOCAL08'; GivenName = 'Hiram'; Surname = 'Cheaper';
                ...
                Path = 'OU=Human Resources,OU=Users,OU=Lab'; ProfileType = 'Mandatory'; ManagedBy = 'LOCAL06'; }
        )

        ServiceAccounts = @(
            @{  SamAccountName = 'RESAM'; GivenName = 'RES'; Surname = 'Service AM';
                Description = 'RES ONE Automation Service Account'; Path = 'OU=Service Accounts,OU=Lab'; }
            @{  SamAccountName = 'RESITS'; GivenName = 'RES'; Surname = 'Service ITS';
                Description = 'RES ONE Service Store Service Account'; Path = 'OU=Service Accounts,OU=Lab'; }
            @{  SamAccountName = 'RESWM'; GivenName = 'RES'; Surname = 'Service WM';
                Description = 'RES ONE Workspace Service Account'; Path = 'OU=Service Accounts,OU=Lab'; }
        )

        ## Universal group required to mail-enable
        Groups = @(
            @{ Name = 'Engineering'; Path = 'OU=Groups,OU=Lab'; Description = 'Engineering users'; Scope = 'Universal'; ManagedBy = 'ROAM02'; }
            @{ Name = 'Executive'; Path = 'OU=Groups,OU=Lab'; Description = 'Executive users'; Scope = 'Universal'; ManagedBy = 'LOCAL05'; }
            @{ Name = 'Finance'; Path = 'OU=Groups,OU=Lab'; Description = 'Finance users'; Scope = 'Universal'; ManagedBy = 'LOCAL03'; }
            @{ Name = 'Information Technology'; Path = 'OU=Groups,OU=Lab'; Description = 'IT users'; Scope = 'Universal'; ManagedBy = 'ROAM01'; }
            @{ Name = 'Marketing'; Path = 'OU=Groups,OU=Lab'; Description = 'Marketing users'; Scope = 'Universal'; ManagedBy = 'LOCAL04'; }
            @{ Name = 'Sales'; Path = 'OU=Groups,OU=Lab'; Description = 'Sales users'; Scope = 'Universal'; ManagedBy = 'LOCAL01'; }
            @{ Name = 'HR'; Path = 'OU=Groups,OU=Lab'; Description = 'Human Resources users'; Scope = 'Universal'; ManagedBy = 'LOCAL06'; }
            @{ Name = 'RES AM Administrators'; Path = 'OU=Groups,OU=Lab'; Description = 'RES ONE Automation administation accounts';
                Members = 'Domain Admins','Information Technology'; Scope = 'DomainLocal'; }
            @{ Name = 'RES AM Service Accounts'; Path = 'OU=Groups,OU=Lab'; Description = 'RES ONE Automation service accounts';
                Members = 'RESAM'; Scope = 'DomainLocal'; }
            @{ Name = 'RES ITS Administrators'; Path = 'OU=Groups,OU=Lab'; Description = 'RES ONE Service Store administation accounts';
                    Members = 'Domain Admins','Information Technology'; Scope = 'DomainLocal'; }
            @{ Name = 'RES ITS Service Accounts'; Path = 'OU=Groups,OU=Lab'; Description = 'RES ONE Service Store service accounts';
                    Members = 'RESITS'; Scope = 'DomainLocal'; }
            @{ Name = 'RES WM Administrators'; Path = 'OU=Groups,OU=Lab'; Description = 'RES ONE Workspace administation accounts';
                    Members = 'Domain Admins','Information Technology'; Scope = 'DomainLocal'; }
            @{ Name = 'RES WM Service Accounts'; Path = 'OU=Groups,OU=Lab'; Description = 'RES ONE Workspace service accounts';
                    Members = 'Domain Admins','RESWM'; Scope = 'DomainLocal'; }
            
            @{ Name = 'FSLogix ODFC'; Path = 'OU=Groups,OU=Lab'; Description = 'FSLogix O365/OneDrive Container user accounts'; Scope = 'DomainLocal'; }
            @{ Name = 'FSLogix Profile Containers'; Path = 'OU=Groups,OU=Lab'; Description = 'FSLogix Profile Container user accounts'; Scope = 'DomainLocal'; }
            @{ Name = 'ProfileUnity'; Path = 'OU=Groups,OU=Lab'; Description = 'Liquidware ProfileUnity user accounts'; Scope = 'DomainLocal'; }
    ...
    #region DNS
    vBaseLabDns 'ReverseLookupAndCNames' {
        IPAddress           = $IPAddress;
    ...
    vBaseLabPasswordPolicy 'PasswordPolicy' {
        DomainName = $DomainName;
    }
    ...
    vBaseLabServiceAccounts 'ServiceAccounts' {
    ...
    vBaseLabPrinters 'Printers' {
        Departments = $departments;
    }

    if ($PSBoundParameters.ContainsKey('ThumbnailPhotoPath')) {

        vBaseLabUserThumbnails 'UserThumbnailPhotos' {
            Users              = $activeDirectory.Users;
        ...
        vBaseLabUserThumbnails 'ServiceAccountPhotos' {
        ...
        vBaseLabUserThumbnails 'AdministratorPhoto' {
